...
insert into LETAO_MM_MATERIAL_TYPE (ID,THAI_NAME,ENGLISH_NAME) values (3,'ของที่ระลึก','Gift');

insert into LETAO_MM_MATERIAL_TYPE (ID,THAI_NAME,ENGLISH_NAME,PARENT) values (4,'เค้ก','Cake',1);
insert into LETAO_MM_MATERIAL_TYPE (ID,THAI_NAME,ENGLISH_NAME,PARENT) values (5,'ชอคโกแลต','Chocolate',1);
