drop table LETAO_MM_MATERIAL;
drop table LETAO_MM_MATERIAL_TYPE;

create table LETAO_MM_MATERIAL_TYPE (
    ID number(19,0) primary key,
    THAI_NAME varchar(80),
    ENGLISH_NAME varchar(80) not null,
    ACTIVE number(1,0) default 1,
    PARENT number(19,0) default 0
        --constraint MATERIAL_TYPE_PARENT_FKEY references LETAO_MM_MATERIAL_TYPE(id)
);

create table LETAO_MM_MATERIAL (
    ID number(19,0) primary key,
    THAI_NAME varchar(80),
    ENGLISH_NAME varchar(80) not null,
    MATERIAL_TYPE_ID number(19,0)
        constraint MATERIAL_MAT_TYPE_FKEY references LETAO_MM_MATERIAL_TYPE(ID),
